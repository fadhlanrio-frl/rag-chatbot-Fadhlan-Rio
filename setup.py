...
try:
    ...
    # (Opsional) Recreate collection secara aman
    ...
    # Upload document secara batching
    ...
    # Error handling di tahap vector setup
...
# Tanda bahwa setup selesai
# Instruksi singkat: jalankan main.py setelah setup sukses
print("\n=== SETUP SELESAI ===")
